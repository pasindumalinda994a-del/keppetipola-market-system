...
const en = {
  ...
  "chart.bookmarkHint": "Select up to {max} items to compare on the chart.",
  "chart.watching": "Watching {n}/{max}: {names}",
  "chart.noMatch": "No produce matches your search.",
  "chart.noItemsInCategory": "No produce in this category.",
  "chart.addToChart": "Add to chart",
  "chart.removeFromChart": "Remove from chart",
  ...
  "chart.bookmarkAbove": "Select produce above to compare their prices on this chart.",
  ...
  "farmer.profile.removePhotoConfirm": "Remove this profile photo?",
  ...
  "admin.vegetables.description": "Catalog of vegetables, tubers, leafy greens, grains, and fruit.",
  ...
  "admin.settings.vegetableCategoriesHint":
    "Comma-separated list. Use Vegetables, Tubers, Leafy greens, Grains & dry goods, and Fruits.",
  ...
  "admin.contact.deleteConfirm": "Delete this message?",
  ...
  "category.leafyGreens": "Leafy greens",
  "category.grains": "Grains & dry goods",
  ...
  "veg.greenChili": "Green Chili",
  "veg.pumpkin": "Pumpkin",
  "veg.ladysFingers": "Lady's Fingers",
  "veg.snakeGourd": "Snake Gourd",
  "veg.bitterGourd": "Bitter Gourd",
  "veg.yardLongBeans": "Yard-Long Beans",
  "veg.ashPlantain": "Ash Plantain",
  "veg.ginger": "Ginger",
  "veg.bigOnion": "Big Onion",
  "veg.ridgeGourd": "Ridge Gourd",
  "veg.drumsticks": "Drumsticks",
  "veg.nookal": "Nookal",
  "veg.athugowa": "Athugowa",
  "veg.potatoesImport": "Potatoes - Import",
  "veg.manioc": "Manioc",
  "veg.sweetPotato": "Sweet Potato",
  "veg.kohila": "Kohila",
  "veg.onionLeaves": "Onion Leaves",
  "veg.mukunuwenna": "Mukunuwenna",
  "veg.gotukola": "Gotukola",
  "veg.curryLeaves": "Curry Leaves",
  "veg.spinach": "Spinach",
  "veg.waterSpinach": "Water Spinach",
  "veg.greenGram": "Green Gram",
  "veg.cowpea": "Cowpea",
  "veg.gram": "Gram",
  "veg.dryChilies": "Dry Chilies",
  "veg.lime": "Lime",
  "veg.jackfruit": "Jackfruit",
  "veg.bananaAmbul": "Banana - Ambul",
  "veg.bananaSini": "Banana - Sini",
  "veg.kolikuttu": "Kolikuttu",
  "veg.coconut": "Coconut",
  "veg.avocado": "Avocado",
  "veg.pineapple": "Pineapple",
  "veg.watermelon": "Watermelon",
  "veg.papaya": "Papaya",
...
const si: Record<MessageKey, string> = {
  ...
  "chart.bookmarkHint": "ප්‍රස්ථාරයේ සසඳන්නට භාණ්ඩ {max}ක් දක්වා තෝරන්න.",
  "chart.watching": "නරඹමින් {n}/{max}: {names}",
  "chart.noMatch": "ඔබේ සෙවුමට ගැලපෙන භාණ්ඩ නැත.",
  "chart.noItemsInCategory": "මෙම කාණ්ඩයේ භාණ්ඩ නැත.",
  "chart.addToChart": "ප්‍රස්ථාරයට එක් කරන්න",
  "chart.removeFromChart": "ප්‍රස්ථාරයෙන් ඉවත් කරන්න",
  ...
  "chart.bookmarkAbove": "මෙම ප්‍රස්ථාරයේ මිල සසඳන්නට ඉහත භාණ්ඩ තෝරන්න.",
  ...
  "farmer.profile.removePhotoConfirm": "මෙම පැතිකඩ ඡායාරූපය ඉවත් කරන්නද?",
  ...
  "admin.vegetables.description": "එළවළු, අල වර්ග, පලා වර්ග, ධාන්‍ය සහ පලතුරු නාමාවලිය.",
  ...
  "admin.announcements.deleteConfirm": "මෙම නිවේදනය මකන්නද?",
  ...
  "admin.settings.vegetableCategoriesHint":
    "කොමාවෙන් වෙන් කළ ලැයිස්තුව. එළවළු, අල වර්ග, පලා වර්ග, ධාන්‍ය සහ පලතුරු භාවිතා කරන්න.",
  ...
  "admin.contact.deleteConfirm": "මෙම පණිවිඩය මකන්නද?",
  ...
  "category.tubers": "අල වර්ග",
  "category.leafyGreens": "පලා වර්ග",
  ...
  "veg.radish": "රාබු",
  "veg.brinjal": "වම්බටු",
  "veg.cauliflower": "මල්ගෝවා",
  "veg.cucumber": "පිපිඤ්ඤා",
  "veg.greenChili": "අමු මිරිස්",
  "veg.pumpkin": "වට්ටක්කා",
  "veg.ladysFingers": "බණ්ඩක්කා",
  "veg.snakeGourd": "පතෝල",
  "veg.bitterGourd": "කරවිල",
  "veg.yardLongBeans": "මෑකරල්",
  "veg.ashPlantain": "අළු කෙසෙල්",
  "veg.ginger": "ඉඟුරු",
  "veg.bigOnion": "ලොකු ළූණු",
  "veg.ridgeGourd": "වැටකොළු",
  "veg.drumsticks": "මුරුංගා",
  "veg.nookal": "නෝකෝල්",
  "veg.athugowa": "අතුගෝවා",
  "veg.potatoesImport": "අර්තාපල් ආනයනික",
  "veg.manioc": "මඤ්ඤොක්කා",
  "veg.sweetPotato": "බතල",
  "veg.kohila": "කොහිල අල",
  "veg.onionLeaves": "ලූණු කොළ",
  "veg.mukunuwenna": "මුකුණුවැන්න",
  "veg.gotukola": "ගොටුකොළ",
  "veg.curryLeaves": "කරපිංචා",
  "veg.spinach": "නිවිති",
  "veg.waterSpinach": "කංකුන්",
  "veg.greenGram": "මුං ඇට",
  "veg.cowpea": "කවුපි",
  "veg.gram": "කඩල",
  "veg.dryChilies": "වියලි මිරිස්",
  "veg.lime": "දෙහි",
  "veg.jackfruit": "පොලොස්",
  "veg.bananaAmbul": "ඇඹල් කෙසෙල්",
  "veg.bananaSini": "සීනි කෙසෙල්",
  "veg.kolikuttu": "කෝලිකුට්ටු",
  "veg.coconut": "පොල්",
  "veg.avocado": "අලි පේර",
  "veg.pineapple": "අන්නාසි",
  "veg.watermelon": "පැණිකොමඩු",
  "veg.papaya": "ගස්ලබු",
...
export const vegetableNameKeys: Record<string, MessageKey> = {
  ...
  "Green Chili": "veg.greenChili",
  Pumpkin: "veg.pumpkin",
  "Lady's Fingers": "veg.ladysFingers",
  "Snake Gourd": "veg.snakeGourd",
  "Bitter Gourd": "veg.bitterGourd",
  "Yard-Long Beans": "veg.yardLongBeans",
  "Ash Plantain": "veg.ashPlantain",
  Ginger: "veg.ginger",
  "Big Onion": "veg.bigOnion",
  "Ridge Gourd": "veg.ridgeGourd",
  Drumsticks: "veg.drumsticks",
  Nookal: "veg.nookal",
  Athugowa: "veg.athugowa",
  "Potatoes - Import": "veg.potatoesImport",
  Manioc: "veg.manioc",
  "Sweet Potato": "veg.sweetPotato",
  Kohila: "veg.kohila",
  "Onion Leaves": "veg.onionLeaves",
  Mukunuwenna: "veg.mukunuwenna",
  Gotukola: "veg.gotukola",
  "Curry Leaves": "veg.curryLeaves",
  Spinach: "veg.spinach",
  "Water Spinach": "veg.waterSpinach",
  "Green Gram": "veg.greenGram",
  Cowpea: "veg.cowpea",
  Gram: "veg.gram",
  "Dry Chilies": "veg.dryChilies",
  Lime: "veg.lime",
  Jackfruit: "veg.jackfruit",
  "Banana - Ambul": "veg.bananaAmbul",
  "Banana - Sini": "veg.bananaSini",
  Kolikuttu: "veg.kolikuttu",
  Coconut: "veg.coconut",
  Avocado: "veg.avocado",
  Pineapple: "veg.pineapple",
  Watermelon: "veg.watermelon",
  Papaya: "veg.papaya",
};
...
export const produceCategoryKeys: Record<string, MessageKey> = {
  ...
  "Grains & dry goods": "category.grains",
};
