...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "-mx-4 -mb-4 flex min-w-0 flex-col-reverse gap-2 rounded-b-lg border-t bg-muted/50 p-4 sm:flex-row sm:justify-end [&>*]:min-w-0 sm:[&>*]:w-auto",
        className
      )}
      {...props}
    >
